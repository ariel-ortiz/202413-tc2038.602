...
class TestOrderedSet(TestCase):
    ...
    def setUp(self) -> None:
        self.a: OrderedSet[int] = OrderedSet(
            [4, 8, 15, 16, 23, 42])
        self.b: OrderedSet[float] = OrderedSet(
            [1.7320508076, 3.1415926536, 1.6180339887,
             3.1622776602, 2.7182818285, 1.4142135624])
        self.c: OrderedSet[str] = OrderedSet(
            ['Dwalin', 'Balin', 'Fili', 'Kili', 'Dori',
             'Nori', 'Ori', 'Oin', 'Gloin', 'Bifur',
             'Bofur', 'Bombur', 'Thorin'])
        self.d: OrderedSet[None] = OrderedSet()
    ...
    #     self.assertFalse(OrderedSet() == self.b)
    ...
    #     self.assertFalse(OrderedSet() == self.c)
    #     d = OrderedSet(self.d)
