= Tc2038.602 Analysis and Design of Advanced Algorithms

_Tecnológico de Monterrey, Estado de México._

This project contains all the source files that the course instructor will be writing in class during the 2024 August-December semester.
...
2. Clone this repository. Type at the terminal:
    ...
    git clone https://github.com/ariel-ortiz/202413-tc2038.602.git tc2038
